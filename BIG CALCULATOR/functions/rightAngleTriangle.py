   ...
   ______________  = A
            ...
            |0| go back''')
                    ...
                    match aski:
                        case "1":
                            ...
                            resultSaver("Right angle triangle", str(round(math.sqrt((leg_a ** 2) + (leg_b ** 2)))), "Right angle triangle pythagora's", "sqrt(leg_a^2 + leg_b^2) = hypotenus")
                            return endMessage(whileLoopKiller)
                        case "2":
                            leg_a = float(input("what's your a: "))
                            hypo = math.sqrt((leg_a ** 2) + (leg_a ** 2))
                            ...
                            resultSaver("Right angle triangle", str(round( math.sqrt((leg_a ** 2) + (leg_a ** 2)))), "Right angle triangle pythagora's with one leg", "sqrt(leg_a^2 + leg_a^2) = hypotenus")
                            return endMessage(whileLoopKiller)
                        case "3":
                            ...
                            resultSaver("Right angle triangle", str(round(  math.sqrt((hypo ** 2) - (leg_a ** 2)))), "Right angle triangle pythagora's with hypotenus and only one leg", "sqrt(hypotenus^2 - leg_a^2) = leg_b")
                            return endMessage(whileLoopKiller)
                        case "4":
                            hypo = float(input("what's your hypotenus: "))
                            legs = math.sqrt((hypo ** 2)/2)
    ...
    sqrt | _________________ | = leg_a
         ...
         '''
            ...
            case _:
                print("that's not an option")
def areatriangle(whileLoopKiller):
    while whileLoopKiller:
        print('''
            |1| Calculate with only 2 legs
            |2| calculate with only a leg
   ...
   _____________  = A
         ...
         '''
                ...
                resultSaver("areas_and_perimeters", str(round((leg_a * leg_b) / 2)), "Right angle triangle area", form)
                return endMessage(whileLoopKiller)
            case "2":
                leg_a = float(input("what's your a: "))
                area = (leg_a ** 2) / 2
   ...
   ________  = A
       2
       '''
                resultSaver("areas_and_perimeters", str(round((leg_a ** 2) / 2)), "Right angle triangle area with only one leg", form)
                return endMessage(whileLoopKiller)
            case "3":
                hypo = float(input("what's your hypotenus: "))
                leg_a = float(input("what's your a: "))
   ...
   _______________  = A
          ...
          '''
                ...
                resultSaver("areas_and_perimeters", str(round((leg_a * leg_b) / 2)), "Right angle triangle area with hypotenus and one leg", form)
                return endMessage(whileLoopKiller)
            case "4":
                hypo = float(input("what's your input: "))
                legs = math.sqrt((hypo ** 2) / 2)
   ...
   ______________  = A
          ...
          '''
                ...
                resultSaver("areas_and_perimeters", str(round((legs ** 2) / 2)), "Right angle triangle area with hypotenus and one leg", form)
                return endMessage(whileLoopKiller)
            case "0":
                return areatriangle
            case _:
                print("that's not an option")
def perimetertriangle(whileLoopKiller):
    while whileLoopKiller:
        print('''
            |1| calculate with all Hypotenus and both legs
            |2| Calculate with only 2 legs
        ...
        match aski:
            case "1":
                ...
                resultSaver("areas_and_perimeters", str(round(hypo + leg_a + leg_b, 2)), "Right angle triangle perimeter", "Hypotenus + leg_a + leg_b = p")
                return endMessage(whileLoopKiller)
            case "2":
                leg_a = float(input("what's your a: "))
                leg_b = float(input("what's your b: "))
                ...
                resultSaver("areas_and_perimeters", str(round(pyth + leg_a + leg_b, 2)), "Right angle triangle perimeter without hypotenus", "sqrt(sqaure(leg_a) + square(leg_b)) = hypotenus + leg_a + leg_b = p")
                return endMessage(whileLoopKiller)
            case "3":
                leg_a = float(input("what's your number: "))
                pyth = math.sqrt((leg_a ** 2) + (leg_a ** 2))
                ...
                resultSaver("areas_and_perimeters", str(round(pyth + leg_a + leg_a, 2)), "Right angle triangle perimeter with only one leg", "sqrt(sqaure(leg_a) + square(leg_a)) = hypotenus + (leg_a * 2)")
                return endMessage(whileLoopKiller)
            case "4":
                hypo = float(input("what's your hypotenus: "))
                leg_a = float(input("what's your a: "))
                ...
                resultSaver("areas_and_perimeters", str(round(pyth + leg_a + c, 2)), "Right angle triangle perimeter with hypotenus and one leg", "sqrt(sqaure(hypotenus) - square(leg_a)) = leg_b + leg_a + hypotenus")
                return endMessage(whileLoopKiller)
            case "5":
                hypo = float(input("what's your hypo: "))
                legs = math.sqrt((hypo ** 2) / 2)
                ...
                resultSaver("areas_and_perimeters", str(round(pyth + legs + legs, 2)), "Right angle triangle perimeter with hypotenus and one leg", "sqrt(sqaure(hypotenus) - square(leg_a)) = leg_b + leg_a + hypotenus")
                return endMessage(whileLoopKiller)
